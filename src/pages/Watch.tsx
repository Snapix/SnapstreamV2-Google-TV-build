  ...
  return (
    <div className={`relative min-h-screen pt-16 sm:pt-20 ${fullscreen ? '!pt-0' : ''}`}>
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-12 py-4">
        <Link
          to="/"
          className="inline-flex items-center gap-1.5 text-sm text-zinc-500 hover:text-white transition-colors mb-6 group"
        >
        ...
        <FadeContent delay={0.1}>
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
            ...
            {/* Left: Player Section */}
            <div className={`space-y-6 ${fullscreen ? 'fixed inset-0 z-50 bg-black' : ''}`}>
              <div className="relative group/player">
                ...
                <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm font-bold text-white/90 hover:bg-white/10 transition-all shadow-xl"
                      >
                    ...
                    {mediaType === 'tv' && seasonCount > 0 && (
                      <div className="relative">
                        <button
                          ...
                          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm font-bold text-white/90 hover:bg-white/10 transition-all shadow-xl"
                        >
                          S{season} • E{episode}
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm font-bold text-white/90 hover:bg-white/10 transition-all"
                  >
